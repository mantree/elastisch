...
(ns clojurewerkz.elastisch.rest-api.get-test-async
  (:require [clojurewerkz.elastisch.rest.document :as doc]
            [clojurewerkz.elastisch.rest.document-async :as doc-async]
...
(let [conn (rest/connect)]
  ...
  (deftest ^{:rest true} test-get-with-existing-id-that-needs-url-encoding
    (let [id "http://www.faz.net/artikel/C31325/piratenabwehr-keine-kriegswaffen-fuer-private-dienste-30683040.html"
          bk (chan)]
      (doc-async/put conn "pages" "page" id {:url id} (fn [r] (>!! bk r)))
      (<!! bk)
      (doc-async/get conn "pages" "page" id (fn [r] (>!! bk r)))
      (is (<!! bk))))
